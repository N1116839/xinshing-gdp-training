...
const GOV_EXAM_QUESTIONS = [
  ...
  ,{questionId:'gov-exam-doc-records',roleKeys:['doc'],level:'staff',topic:'公開查核重點：文件與紀錄',questionText:'依食藥署 113 年度公開常見缺失，文件管理最應避免哪一種情形？',options:['SOP 與實際作業不一致，或紀錄未完整、即時且可追溯','文件使用正式編號','文件修訂後安排訓練','紀錄由權責人簽認'],correctIndex:0,explanation:'公開查核會確認 SOP、現場作業與品質紀錄的一致性及可追溯性。',sourceTitle:'TFDA 113年度GDP申請資料準備與常見缺失',sourceSection:'文件與紀錄公開查核重點',sourceQuote:'GDP 相關紀錄與實際作業須一致、完整且可追溯。',sourceId:'gov-src-tfda-113'}
  ,{questionId:'gov-exam-doc-training-record',roleKeys:['doc'],level:'staff',topic:'公開查核重點：訓練文件',questionText:'依食藥署公開查核重點，教育訓練相關文件應能證明什麼？',options:['人員已完成訓練、考核結果可追溯，未合格者有補訓與再評鑑','只要有課程名稱即可','只保存講義不需紀錄','只記錄合格人員'],correctIndex:0,explanation:'公開查核會確認訓練有效性、補訓及再評鑑紀錄。',sourceTitle:'TFDA 113年度GDP申請資料準備與常見缺失',sourceSection:'教育訓練公開查核重點',sourceQuote:'訓練有效性應有考核、補訓及再評鑑的可追溯紀錄。',sourceId:'gov-src-tfda-113'}
  ,{questionId:'gov-exam-hr-effectiveness',roleKeys:['hr'],level:'staff',topic:'公開查核重點：訓練有效性',questionText:'依食藥署 113 年度公開常見缺失，訓練完成後還必須確認什麼？',options:['受訓成效；認知不足或不合格時須補訓並再次評鑑','只要簽到即可','由員工自行決定是否複習','下年度再統一確認'],correctIndex:0,explanation:'公開缺失包括訓練有效性未評估，以及不合格未補訓再評鑑。',sourceTitle:'TFDA 113年度GDP申請資料準備與常見缺失',sourceSection:'教育訓練公開常見缺失',sourceQuote:'訓練有效性未評估，或認知不足時未依程序補訓並再次評鑑合格。',sourceId:'gov-src-tfda-113'}
  ,{questionId:'gov-exam-hr-counterfeit-training',roleKeys:['hr'],level:'staff',topic:'公開查核重點：必訓紀錄',questionText:'依食藥署公開查核重點，偽禁仿冒藥識別訓練的紀錄應如何管理？',options:['確認相關人員完成訓練且有合格紀錄','只在新人到職時口頭提醒','由管理藥師一人受訓即可','不需評量結果'],correctIndex:0,explanation:'偽禁仿冒藥識別訓練及合格紀錄是公開查核重點。',sourceTitle:'TFDA 113年度GDP申請資料準備與常見缺失',sourceSection:'教育訓練公開常見缺失',sourceQuote:'偽禁仿冒藥識別訓練未完成或無合格紀錄。',sourceId:'gov-src-tfda-113'}
  ,{questionId:'gov-exam-purchase-qualification',roleKeys:['purchase'],level:'staff',topic:'公開查核重點：供應商資格',questionText:'依食藥署 111 年度公開常見缺失，採購在供應商管理應優先確認什麼？',options:['供應商資格認可完整，並確認 GDP／GMP 符合性','報價最低','距離最近','產品品項最多'],correctIndex:0,explanation:'供應商資格認可不完整、未確認 GDP/GMP 符合性是公開缺失。',sourceTitle:'TFDA 111年度GDP實地查核流程與常見缺失',sourceSection:'供應商管理公開常見缺失',sourceQuote:'供應商資格認可不完整，未確認其 GDP/GMP 符合性。',sourceId:'gov-src-tfda-111'}
  ,{questionId:'gov-exam-purchase-traceability',roleKeys:['purchase'],level:'staff',topic:'公開查核重點：進貨追溯',questionText:'依食藥署 111 年度公開查核重點，進貨紀錄至少應具備哪些可追溯資訊？',options:['批號、效期與供應商等資訊','採購人員心得','供應商廣告文宣','當日天氣'],correctIndex:0,explanation:'公開缺失包括進貨紀錄缺少批號、效期與供應商等追溯資料。',sourceTitle:'TFDA 111年度GDP實地查核流程與常見缺失',sourceSection:'進貨紀錄公開常見缺失',sourceQuote:'進貨紀錄常缺批號、效期與供應商等可追溯資訊。',sourceId:'gov-src-tfda-111'}
  ,{questionId:'gov-exam-pharmacist-recall',roleKeys:['pharmacist'],level:'staff',topic:'公開查核重點：回收演練',questionText:'依食藥署公開查核重點，藥品回收管理應定期確認哪一項？',options:['執行模擬回收以評估回收作業有效性','只確認倉庫空間','只確認回收紙箱','只確認通知信格式'],correctIndex:0,explanation:'公開查核會確認是否定期執行模擬回收以評估有效性。',sourceTitle:'TFDA 111年度GDP實地查核流程與常見缺失',sourceSection:'藥品回收公開查核重點',sourceQuote:'是否定期執行模擬回收以評估回收作業的有效性。',sourceId:'gov-src-tfda-111'}
  ,{questionId:'gov-exam-pharmacist-counterfeit',roleKeys:['pharmacist'],level:'staff',topic:'公開查核重點：偽禁仿冒藥',questionText:'依食藥署公開常見缺失，疑似偽禁仿冒藥程序的定義範圍應避免什麼缺口？',options:['未納入退回品、異常低價品等所有可能來源','文件字數太多','只由藥師保管','程序更新太頻繁'],correctIndex:0,explanation:'公開缺失指出程序範圍須涵蓋所有可能的疑似品來源。',sourceTitle:'TFDA 111年度GDP實地查核流程與常見缺失',sourceSection:'偽禁仿冒藥公開常見缺失',sourceQuote:'定義範圍不完整，未納入退回品、異常低價品等所有可能來源。',sourceId:'gov-src-tfda-111'}
  ,{questionId:'gov-exam-qa-capa',roleKeys:['qa'],level:'staff',topic:'公開查核重點：CAPA',questionText:'依食藥署 111 年度公開常見缺失，CAPA 最常見且必須避免的問題是什麼？',options:['只描述表面現象，未做根本原因分析或未確認改善有效性','CAPA 表單顏色不對','CAPA 份數太少','沒有印表機列印'],correctIndex:0,explanation:'公開缺失聚焦根本原因分析及改善有效性確認。',sourceTitle:'TFDA 111年度GDP實地查核流程與常見缺失',sourceSection:'CAPA 公開常見缺失',sourceQuote:'只描述表面現象，未做根本原因分析或未確認改善有效性。',sourceId:'gov-src-tfda-111'}
  ,{questionId:'gov-exam-qa-audit',roleKeys:['qa'],level:'staff',topic:'公開查核重點：偏差與稽核',questionText:'依食藥署公開查核重點，偏差處理應做到什麼？',options:['即時提報並完成根本原因分析與風險評估','等年度稽核再處理','由一人私下處理','盡量不要記錄'],correctIndex:0,explanation:'偏差應即時提報並完成根本原因與風險評估。',sourceTitle:'TFDA 111年度GDP實地查核流程與常見缺失',sourceSection:'偏差管理公開查核重點',sourceQuote:'偏差是否即時提報並完成根本原因分析與風險評估。',sourceId:'gov-src-tfda-111'}
];
